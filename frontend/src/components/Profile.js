...
const classes = {
    input: "p-1 px-2 border border-slate-900 mr-5 block lg:inline",
    ...
    if (user !== null && user !== "nouser") {
        return (
            <div className="p-5 divide-y-2 divide-slate-400">
                <div className="flex md:flex-row flex-col w-full justify-between mb-5">
                    <div>
                ...
                <form
                    ...
                    className="p-5 flex md:flex-row flex-col justify-between items-center bg-slate-200 my-5 hidden"
                >
                    <div>
                        <label>
                            First Name :{" "}
                            <input
                                ...
                                id="firstName"
                                name="firstName"
                                className={classes.input + " w-64 md:w-80"}
                        ...
                        <label>
                            ...
                            <input
                                ...
                                id="lastName"
                                name="lastName"
                                className={classes.input + " w-64 md:w-80 mb-2"}
